...
quora=read.csv("C:/Users/kanne/Desktop/data/quora.csv",sep=",",header = TRUE)
...
predict_log<-predict(logistic,newdata = tr1[,-c(1)])
...
#tr1[,c(1,3:6)] = lapply(tr1[,c(1,3:6)],as.factor)
